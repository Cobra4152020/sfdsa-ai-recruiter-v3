    ...
    <div className="flex flex-col sm:flex-row gap-4 p-4 bg-white rounded-lg shadow-sm">
      ...
      <div className="flex-1">
        ...
        <select
          ...
          value={filters.type}
          onChange={(e) =>
            handleFilterChange("type", e.target.value as BadgeType | "all")
          }
      ...
      <div className="flex-1">
        ...
        <select
          ...
          onChange={(e) =>
            handleFilterChange("rarity", e.target.value as BadgeRarity | "all")
          }
          className="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
        >
      ...
      <div className="flex-1">
        ...
        <select
          ...
          onChange={(e) =>
            handleFilterChange(
              "status",
              e.target.value as BadgeFilters["status"],
            )
          }
          className="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
        >
      ...
      <div className="flex-1">
        ...
        <select
          ...
          onChange={(e) =>
            handleFilterChange(
              "sortBy",
              e.target.value as BadgeFilters["sortBy"],
            )
          }
          className="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
        >
      ...
      <div className="flex items-end">
        <button
          ...
          className="w-full sm:w-auto px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-accent/10 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
        >
          Clear Filters
        </button>
      </div>
