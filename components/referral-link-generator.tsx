...
import { Facebook, Twitter, Linkedin, Mail, Copy, Share2, Link } from "lucide-react"
...
export function ReferralLinkGenerator() {
  ...
  const baseUrl = process.env.NEXT_PUBLIC_SITE_URL || "https://deputyrecruiter.sf.gov"
  ...
  const shareViaEmail = () => {
    const subject = encodeURIComponent("Join the San Francisco Sheriff's Department")
    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Create a custom, trackable link that you can share with potential recruits. When they sign up using your
            link, you'll get credit for the referral.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          <div className="space-y-4">
            ...
            <div className="bg-gray-100 dark:bg-gray-800 p-4 rounded-md flex items-center">
              <div className="flex-1 font-mono text-sm truncate">{referralUrl}</div>
              <Button variant="outline" size="icon" onClick={handleCopyLink} className="ml-2 flex-shrink-0">
          ...
          <div>
            ...
            <Tabs value={shareTab} onValueChange={setShareTab}>
              ...
              <TabsContent value="copy" className="mt-4">
                <Button onClick={handleCopyLink} className="w-full bg-[#0A3C1F] hover:bg-[#0A3C1F]/90">
                  <Copy className="h-4 w-4 mr-2" />
              ...
              <TabsContent value="email" className="mt-4">
                <Button onClick={shareViaEmail} className="w-full bg-[#0A3C1F] hover:bg-[#0A3C1F]/90">
                  <Mail className="h-4 w-4 mr-2" />
                  Share via Email
                </Button>
              </TabsContent>
              ...
              <TabsContent value="facebook" className="mt-4">
                <Button onClick={shareViaFacebook} className="w-full bg-[#0A3C1F] hover:bg-[#0A3C1F]/90">
                  <Facebook className="h-4 w-4 mr-2" />
                  Share on Facebook
                </Button>
              </TabsContent>
              ...
              <TabsContent value="twitter" className="mt-4">
                <Button onClick={shareViaTwitter} className="w-full bg-[#0A3C1F] hover:bg-[#0A3C1F]/90">
                  <Twitter className="h-4 w-4 mr-2" />
                  Share on Twitter
                </Button>
              </TabsContent>
              ...
              <TabsContent value="linkedin" className="mt-4">
                <Button onClick={shareViaLinkedIn} className="w-full bg-[#0A3C1F] hover:bg-[#0A3C1F]/90">
                  <Linkedin className="h-4 w-4 mr-2" />
                  Share on LinkedIn
                </Button>
              </TabsContent>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            View and manage all your active referral links. You can see how many clicks each link has received and how
            many sign-ups it has generated.
          </CardDescription>
        </CardHeader>
        <CardContent>
            ...
            <table className="w-full">
              ...
              <tbody>
                <tr className="border-b">
                  <td className="py-3 px-4">
                    <div className="flex items-center">
                      ...
                      <span className="text-sm font-medium truncate max-w-[200px]">{baseReferralCode}</span>
                    </div>
                  </td>
                ...
                <tr className="border-b">
                  ...
                  <td className="text-center py-3 px-4 text-sm">July 22, 2023</td>
