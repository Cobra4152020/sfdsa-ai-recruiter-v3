...
export function EnhancedLoginForm() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      const result = await enhancedAuthService.signInWithPassword(email, password, {
        rememberMe,
      })
  ...
  return (
    <>
      ...
      <EnhancedSocialLogin onLoginStart={() => setError(null)} className="mb-6" showApple={true} showLinkedin={true} />
