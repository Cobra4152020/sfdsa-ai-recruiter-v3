        ...
        <div className="space-y-4 text-sm">
          ...
          <div className="flex items-start">
            ...
            <div>
              ...
              <div className="space-y-2 mt-2">
                <div>
                  <Badge variant="outline" className="mb-1">Normal Mode</Badge>
                  <p className="text-gray-600">Standard gameplay with 30 seconds per question.</p>
                </div>
                <div>
                  <Badge variant="destructive" className="mb-1">Challenge Mode</Badge>
                  <p className="text-gray-600">15 seconds per question with 2x points multiplier!</p>
                </div>
                <div>
                  <Badge variant="default" className="mb-1">Study Mode</Badge>
                  <p className="text-gray-600">No time pressure, detailed explanations, and review cards for incorrect answers.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-start">
            ...
            <div>
              ...
              <p className="text-gray-600">
                Normal Mode: 30 seconds per question<br />
                Challenge Mode: 15 seconds per question<br />
          ...
          <div className="flex items-start">
            ...
            <div>
              ...
              <p className="text-gray-600">Base points are multiplied by various bonuses:</p>
          ...
          <div className="flex items-start">
            ...
            <div>
              ...
              <ul className="list-disc list-inside ml-4 mt-1 text-gray-600">
                ...
                <li>Speed Demon: Answer 10 questions in under 5 seconds each</li>
                <li>Challenge Champion: Complete a perfect round in Challenge Mode</li>
              </ul>
            </div>
          </div>
          ...
          <div className="bg-[#0A3C1F]/10 p-3 rounded-lg mt-4">
            ...
            <ul className="text-sm text-gray-600 mt-2 space-y-1">
              ...
              <li>• Try Challenge Mode once you're confident for double points!</li>
              <li>• Share your achievements to help spread the word about SFSO recruitment</li>
            </ul>
          </div>
        </div>
      </CardContent>
