  ...
  const checkHealth = async () => {
    ...
    try {
      ...
      if (err instanceof Error) {
        ...
        setError("Failed to check Supabase health");
      }
    } finally {
      setLoading(false);
    }
  ...
  return (
    <Card className="w-full">
      <CardHeader>
        ...
        <CardDescription>
          Checks the connection to Supabase and verifies required tables
        </CardDescription>
      </CardHeader>
        ...
        {loading ? (
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-gray-50 p-3 rounded-md">
                ...
                <div className="flex items-center gap-1">
                  ...
                  <span className="font-medium">
                    {healthData.details.connectionTimeMs}ms
                  </span>
                </div>
              </div>
              ...
              <div className="bg-gray-50 p-3 rounded-md">
                ...
                <div className="flex items-center gap-1">
                  <Clock className="h-4 w-4 text-gray-400" />
                  <span className="font-medium">
                    {healthData.details.totalResponseTimeMs}ms
                  </span>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div
                className={`p-3 rounded-md ${healthData.details.permissions.success ? "bg-green-50" : "bg-red-50"}`}
              >
                {healthData.details.permissions.success ? (
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm text-red-600">
                      {healthData.details.permissions.error}
                    </p>
                  </div>
                )}
              </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-3 gap-2">
                ...
                >
                  Supabase URL:{" "}
                  {healthData.details.environment.hasSupabaseUrl
                    ? "Set"
                    : "Missing"}
                </div>
                <div
                ...
                >
                  Anon Key:{" "}
                  {healthData.details.environment.hasSupabaseAnonKey
                    ? "Set"
                    : "Missing"}
                </div>
                <div
                ...
                >
                  Service Key:{" "}
                  {healthData.details.environment.hasSupabaseServiceKey
                    ? "Set"
                    : "Missing"}
                </div>
              </div>
