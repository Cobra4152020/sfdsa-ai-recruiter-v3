...
import { Copy, Check, Twitter, Facebook, Linkedin, Mail, Share2, MessageCircle } from "lucide-react"
...
export function AchievementShareDialog({ isOpen, onClose, achievement }: AchievementShareDialogProps) {
  ...
  const handleShare = async (platform: SocialPlatform) => {
    ...
    try {
      ...
      const result = await SocialSharingService.share(platform, shareOptions, currentUser?.id)
