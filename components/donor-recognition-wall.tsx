...
export function DonorRecognitionWall() {
  ...
  function filterDonors() {
    ...
    if (searchTerm) {
      ...
      result = result.filter(
        (donor) =>
          ...
          (donor.organization && donor.organization.toLowerCase().includes(term)),
      )
    }
    ...
    if (timeframe !== "all") {
      ...
      result = result.filter((donor) => new Date(donor.donation_date) >= cutoffDate)
    }
  ...
  const benefactors = filteredDonors.filter((donor) => donor.tier === "benefactor")
  const champions = filteredDonors.filter((donor) => donor.tier === "champion")
  const supporters = filteredDonors.filter((donor) => donor.tier === "supporter")
    ...
    <div className="space-y-8">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <div className="flex gap-2 w-full md:w-auto">
          <Select value={timeframe} onValueChange={(value: "all" | "month" | "year") => setTimeframe(value)}>
        ...
        <Tabs defaultValue="all" className="w-full">
          ...
          <TabsContent value="all" className="space-y-8 pt-6">
            ...
            {filteredDonors.length === 0 && (
              <div className="text-center py-12 bg-gray-50 rounded-lg">
                ...
                <h3 className="text-xl font-semibold text-gray-500">No donors found</h3>
          ...
          <TabsContent value="benefactors" className="pt-6">
            {benefactors.length > 0 ? (
              ...
              <div className="text-center py-12 bg-gray-50 rounded-lg">
                <Heart className="h-12 w-12 text-gray-300 mx-auto mb-4" />
                <h3 className="text-xl font-semibold text-gray-500">No benefactors found</h3>
                <p className="text-gray-400 mt-2">Try adjusting your search or filters</p>
              </div>
            )}
          </TabsContent>
          ...
          <TabsContent value="champions" className="pt-6">
            {champions.length > 0 ? (
              ...
              <div className="text-center py-12 bg-gray-50 rounded-lg">
                <Heart className="h-12 w-12 text-gray-300 mx-auto mb-4" />
                <h3 className="text-xl font-semibold text-gray-500">No champions found</h3>
                <p className="text-gray-400 mt-2">Try adjusting your search or filters</p>
              </div>
            )}
          </TabsContent>
          ...
          <TabsContent value="supporters" className="pt-6">
            {supporters.length > 0 ? (
              ...
              <div className="text-center py-12 bg-gray-50 rounded-lg">
                <Heart className="h-12 w-12 text-gray-300 mx-auto mb-4" />
                <h3 className="text-xl font-semibold text-gray-500">No supporters found</h3>
                <p className="text-gray-400 mt-2">Try adjusting your search or filters</p>
              </div>
            )}
          </TabsContent>
          ...
          <TabsContent value="friends" className="pt-6">
            {friends.length > 0 ? (
              ...
              <div className="text-center py-12 bg-gray-50 rounded-lg">
                <Heart className="h-12 w-12 text-gray-300 mx-auto mb-4" />
                <h3 className="text-xl font-semibold text-gray-500">No friends found</h3>
                <p className="text-gray-400 mt-2">Try adjusting your search or filters</p>
              </div>
            )}
          </TabsContent>
      ...
      <div className="bg-[#0A3C1F]/5 p-6 rounded-lg mt-12">
        <h2 className="text-xl font-bold text-[#0A3C1F] mb-4">Become a Recognized Donor</h2>
        <p className="text-gray-600 mb-4">
          Would you like to join our community of supporters? Your contribution, no matter the size, makes a difference
          in our mission to build a stronger, safer San Francisco.
        </p>
        <div className="flex justify-center mt-6">
          <Button className="bg-[#0A3C1F] hover:bg-[#0A3C1F]/90" size="lg" asChild>
      ...
      <div className="text-center text-sm text-gray-500 mt-8">
        <p>
          Only donors who have given explicit permission are displayed on this page. If you've made a donation and would
          like to be recognized (or removed), please contact us at{" "}
          <a href="mailto:donations@protectingsanfrancisco.com" className="text-[#0A3C1F] hover:underline">
