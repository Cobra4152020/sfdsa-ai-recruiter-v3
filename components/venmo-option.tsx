...
export function VenmoOption({
  ...
  donorName,
  donorEmail,
  organization: _, // eslint-disable-line @typescript-eslint/no-unused-vars
}: VenmoOptionProps) {
  ...
  const handleVenmoClick = () => {
    ...
    toast({
      title: "Opening Venmo",
      description:
        "If Venmo doesn&apos;t open automatically, please use the QR code or copy our username.",
    });
        ...
        <div className="text-center">
          ...
          <div className="mb-4">
            <p className="text-sm text-gray-600">
              Please include your name and &quot;Donation to Protecting San
              Francisco&quot; in the payment note.
            </p>
          </div>
