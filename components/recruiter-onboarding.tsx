  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description:
          "Your volunteer recruiter application has been submitted for review.",
        duration: 5000,
      });
      ...
      console.error("Application submission error:", _error);
      toast({
        title: "Error",
        description:
    ...
    <div className="max-w-3xl mx-auto">
      <div className="text-center space-y-4 mb-8">
        <h1 className="text-3xl md:text-4xl font-bold text-primary">
          Volunteer Recruiter Program
        </h1>
        <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
          Join our team of volunteer recruiters and help build the future of the
      ...
      <div className="flex justify-between mb-8 relative">
        ...
        <div
          className={`relative z-10 flex flex-col items-center ${step >= 1 ? "text-primary" : "text-muted-foreground"}`}
        >
          <div
        ...
        <div
          className={`relative z-10 flex flex-col items-center ${step >= 2 ? "text-primary" : "text-muted-foreground"}`}
        >
          <div
        ...
        <div
          className={`relative z-10 flex flex-col items-center ${step >= 3 ? "text-primary" : "text-muted-foreground"}`}
        >
          <div
      ...
      {step === 1 && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Fill out the form below to join our volunteer recruiter program.
              Once approved, you&apos;ll be able to refer candidates and track
              your referrals.
            </CardDescription>
          </CardHeader>
          <CardContent>
            ...
            >
              ...
              <div className="space-y-2">
                <Label htmlFor="referralSource">
                  How did you hear about our volunteer recruiter program?
                </Label>
                <Select
                  value={formData.referralSource}
                  onValueChange={(value) =>
                    handleSelectChange("referralSource", value)
                  }
                >
                  ...
                  <SelectContent>
                    <SelectItem value="current_employee">
                      Current Sheriff&apos;s Department Employee
                    </SelectItem>
                    <SelectItem value="former_employee">
                      Former Sheriff&apos;s Department Employee
                    </SelectItem>
              ...
              <div className="space-y-2">
                <Label htmlFor="reason">
                  Why do you want to become a volunteer recruiter?{" "}
      ...
      {step === 2 && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Please review your information and agree to the terms and
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-2">
                  ...
                  >
                    ...
                    and acknowledge my responsibilities as a volunteer
                    recruiter.
                  </label>
                </div>
      ...
      {step === 3 && (
        <Card>
          <CardHeader className="text-center">
            ...
            <CardDescription>
              Thank you for applying to our volunteer recruiter program.
            </CardDescription>
          </CardHeader>
          <CardContent className="text-center space-y-4">
            ...
            <p>
              Once approved, you&apos;ll be able to generate referral links,
              contact potential recruits, and track your performance through
