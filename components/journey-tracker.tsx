...
export function JourneyTracker({
  ...
  useEffect(() => {
    ...
    if (journeyIdRef.current && stepName && !isStart && !isComplete && !isAbandon) {
    ...
    if (isAbandon && journeyIdRef.current) {
      abandonJourney(journeyIdRef.current, metadata.reason || "user-abandoned", {
        ...metadata,
        path: window.location.pathname,
  ...
  }, [journeyName, stepName, isStart, isComplete, isAbandon, metadata, metrics])
...
export function RegistrationJourney(props: Omit<JourneyTrackerProps, "journeyName">) {
  return <JourneyTracker journeyName={JOURNEY_TYPES.REGISTRATION} {...props} />
}

export function ApplicationJourney(props: Omit<JourneyTrackerProps, "journeyName">) {
  return <JourneyTracker journeyName={JOURNEY_TYPES.APPLICATION} {...props} />
}

export function BadgeEarningJourney(props: Omit<JourneyTrackerProps, "journeyName">) {
  return <JourneyTracker journeyName={JOURNEY_TYPES.BADGE_EARNING} {...props} />
}

export function GamePlayingJourney(props: Omit<JourneyTrackerProps, "journeyName">) {
  return <JourneyTracker journeyName={JOURNEY_TYPES.GAME_PLAYING} {...props} />
}

export function ProfileViewJourney(props: Omit<JourneyTrackerProps, "journeyName">) {
...
export function LeaderboardJourney(props: Omit<JourneyTrackerProps, "journeyName">) {
