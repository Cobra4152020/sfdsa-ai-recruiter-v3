...
export function RecentApplicantsWrapper({ applicants, onViewAll }: RecentApplicantsWrapperProps) {
    ...
    <Card>
      <CardHeader>
        <div className="flex items-center justify-between">
          <div>
            <CardTitle className="text-lg font-bold text-[#0A3C1F]">Recent Applicants</CardTitle>
            <CardDescription>Latest deputy sheriff applicants</CardDescription>
          </div>
          {onViewAll && (
            <Button variant="outline" className="text-[#0A3C1F]" onClick={onViewAll}>
              View All
