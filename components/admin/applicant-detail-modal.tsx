...
export function ApplicantDetailModal({ applicant, onClose, onUpdateStatus }: ApplicantDetailModalProps) {
      ...
      <DialogContent className="max-w-3xl">
        ...
        <Tabs defaultValue="details">
              ...
              <div>
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    <p className="font-medium">{applicant.zip_code || "Not provided"}</p>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    <p className="font-medium">{applicant.referral_source || "Direct"}</p>
                  </div>
            ...
            <div className="pt-4 border-t">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="flex items-end gap-2">
                  <Button onClick={handleUpdateStatus} disabled={status === applicant.application_status}>
                    Update Status
                  </Button>

                  <Button variant="outline" onClick={handleSendStatusEmail} disabled={isSendingEmail}>
          ...
          <TabsContent value="activity" className="pt-4">
            <div className="text-center py-8 text-gray-500">Activity log will be implemented in a future update.</div>
          </TabsContent>

          <TabsContent value="notes" className="pt-4">
            <div className="text-center py-8 text-gray-500">Notes feature will be implemented in a future update.</div>
          </TabsContent>
        </Tabs>
