...
export function ApplicantTable({ applicants, isLoading, onViewDetails, onUpdateStatus }: ApplicantTableProps) {
        ...
        <TableBody>
          {sortedApplicants.map((applicant) => (
            <TableRow key={applicant.id}>
              ...
              <TableCell className="font-mono text-sm">{applicant.tracking_number}</TableCell>
              ...
              <TableCell className="text-right">
                <div className="flex justify-end">
                  <Button variant="ghost" size="icon" onClick={() => onViewDetails(applicant)} title="View Details">
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end">
                      <DropdownMenuItem onClick={() => onUpdateStatus(applicant.id, "pending")}>
                        Mark as Pending
                      </DropdownMenuItem>
                      <DropdownMenuItem onClick={() => onUpdateStatus(applicant.id, "contacted")}>
                        Mark as Contacted
                      </DropdownMenuItem>
                      <DropdownMenuItem onClick={() => onUpdateStatus(applicant.id, "interested")}>
                        Mark as Interested
                      </DropdownMenuItem>
