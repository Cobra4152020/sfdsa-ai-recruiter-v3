...
export function DatabaseSchemaUpdateButton() {
    ...
    try {
      ...
      if (result.success) {
        toast({
          ...
          description: "The database schema has been successfully updated with separate user tables.",
          variant: "default",
        })
      } else {
        toast({
  ...
  return (
    <Button onClick={handleUpdate} disabled={isUpdating} className="bg-[#0A3C1F] hover:bg-[#0A3C1F]/80">
