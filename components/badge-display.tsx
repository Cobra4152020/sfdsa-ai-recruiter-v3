...
export function BadgeDisplay() {
  ...
  const badges = [
    {
      type: "written",
      name: "Written Exam",
      description: "Awarded for completing the written examination.",
    },
    {
      type: "oral",
      name: "Oral Interview",
      description: "Awarded for completing the oral interview.",
    },
    {
      type: "physical",
      name: "Physical Test",
      description: "Awarded for passing the physical agility test.",
    },
    {
      type: "polygraph",
      name: "Polygraph",
      description: "Awarded for completing the polygraph examination.",
    },
    {
      type: "psychological",
      name: "Psychological",
    ...
    },
    {
      type: "full",
      name: "Full Process",
      description: "Awarded for completing the entire application process.",
    },
    {
    ...
    },
    {
      type: "frequent-user",
      name: "Frequent User",
      description: "Awarded for regular engagement with our platform.",
    },
    {
  ...
  const filteredBadges = badges.filter((badge) => {
    ...
    if (activeTab === "achievement")
      return ["hard-charger"].includes(badge.type);
    return true;
  });
