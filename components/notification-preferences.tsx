...
export function NotificationPreferences({ userId }: NotificationPreferencesProps) {
  ...
  return (
    <Card>
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            <div className="space-y-0.5">
              ...
              <p className="text-sm text-muted-foreground">Notifications about donations and fundraising</p>
            </div>
            <Switch
          ...
          <div className="flex items-center justify-between">
            <div className="space-y-0.5">
              ...
              <p className="text-sm text-muted-foreground">Notifications about badge awards and achievements</p>
            </div>
            <Switch
          ...
          <div className="flex items-center justify-between">
            <div className="space-y-0.5">
              ...
              <p className="text-sm text-muted-foreground">Notifications about your achievements and milestones</p>
            </div>
            <Switch
      ...
      <CardFooter>
        <Button onClick={saveSettings} disabled={loading || saving} className="ml-auto">
