...
export function PointsGateWrapper({
  children,
  requiredPoints,
  actionName,
  fallback,
}: PointsGateWrapperProps) {
        ...
        fallback || (
          <div className="p-4 bg-amber-50 dark:bg-amber-900/20 rounded-md text-center">
            <p className="text-amber-800 dark:text-amber-300">
              You need {requiredPoints} points to access this feature. You
              currently have {currentUser.participation_count} points.
            </p>
          </div>
        )
      );
