...
export function PerformanceWidget({ data }: PerformanceWidgetProps) {
  ...
  const overallRating = [cpuRating, memoryRating, diskRating].includes("poor")
    ? "poor"
    : [cpuRating, memoryRating, diskRating].includes("needs-improvement")
      ? "needs-improvement"
      : "good";
            ...
            <div className="h-2 bg-gray-200 rounded-full overflow-hidden">
              <div
                className={`h-full rounded-full ${
                  memoryRating === "good"
                    ? "bg-green-500"
                    : memoryRating === "needs-improvement"
                      ? "bg-yellow-500"
                      : "bg-red-500"
                }`}
                style={{
