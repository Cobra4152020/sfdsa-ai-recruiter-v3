            ...
            {brokenLinks.length > 0 && (
              <div className="mb-4">
                ...
                {brokenLinks.map((result, index) => (
                  <div
                    key={index}
                    className="p-3 mb-2 rounded-lg border border-red-200 bg-red-50 flex items-start"
                  >
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                  {validLinks.map((result, index) => (
                    <div
                      key={index}
                      className="p-3 rounded-lg border border-green-200 bg-green-50 flex items-start"
                    >
                      ...
                      <div className="flex-1 overflow-hidden">
                        ...
                        <div className="text-xs text-gray-500 flex items-center">
                          ...
                          !result.url.includes(window.location.hostname) ? (
