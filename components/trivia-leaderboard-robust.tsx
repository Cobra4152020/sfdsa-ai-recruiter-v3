...
export function TriviaLeaderboardRobust() {
      ...
      <CardContent className="p-4">
        {isLoading ? (
          ...
          <div className="text-center py-6 text-gray-500">
            <p>No trivia players yet. Be the first!</p>
          </div>
        ) : (
          <div className="space-y-3">
              ...
              <div key={entry.user_id} className="flex items-center space-x-3">
                ...
                <div className="flex-1">
                  ...
                  <div className="text-xs text-gray-500">
                    {entry.total_correct_answers} correct answers (
                    {Math.round(entry.accuracy_percent)}% accuracy)
                  </div>
                </div>
              </div>
            ))}
