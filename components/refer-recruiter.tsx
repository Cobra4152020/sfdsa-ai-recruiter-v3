    ...
    <>
        ...
        <CardContent className="pt-6">
          <form onSubmit={handleSubmit}>
            <div className="grid gap-4">
              ...
              <Button type="submit" className="mt-2 bg-[#0A3C1F] hover:bg-[#0A3C1F]/90 text-white">
          ...
          <div className="mt-6 pt-6 border-t">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li className="flex justify-between">
                ...
                <span className="text-[#0A3C1F] font-medium">"Connector" Badge</span>
              </li>
              <li className="flex justify-between">
              ...
              <li className="flex justify-between">
                ...
                <span className="text-[#0A3C1F] font-medium">"Recruitment Champion" NFT</span>
              </li>
            </ul>
          </div>
        </CardContent>
      ...
      <Dialog open={showAuthDialog} onOpenChange={setShowAuthDialog}>
        <DialogContent className="sm:max-w-md">
          ...
          <DialogDescription>Sign in to refer friends and earn rewards</DialogDescription>
      ...
      <Dialog open={showSuccessDialog} onOpenChange={setShowSuccessDialog}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>Share this custom referral link to earn even more points and rewards.</DialogDescription>
          </DialogHeader>
          ...
          <div className="py-4">
            ...
            <p className="text-sm text-gray-500 mt-2">
              Your friend will receive an email with this link and you'll be credited when they sign up.
            </p>
          </div>
