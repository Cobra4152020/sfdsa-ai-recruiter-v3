...
import { Trophy, Gamepad2, Award, Star, ArrowRight } from "lucide-react";
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              Engage in fun activities, earn points, and progress in your
              journey to become a San Francisco Deputy Sheriff.
            </p>
          </div>
