...
export const metadata: Metadata = {
  ...
  description:
    "Learn about the step-by-step process to become a San Francisco Deputy Sheriff.",
};
...
export default function ApplicationProcessPage() {
  const steps = [
    ...
    },
    {
      ...
      timeframe: "Half day",
      tips: [
        "Train regularly before the test",
    ...
    },
    {
      ...
      description:
        "Complete a comprehensive medical examination to ensure you meet health requirements.",
      timeframe: "1-2 days",
    ...
    },
    {
      ...
      description:
        "Undergo psychological testing and interview with a licensed psychologist.",
      timeframe: "1-2 days",
      tips: [
        "Be honest and forthright",
        "Get adequate rest before the evaluation",
      ],
    },
    {
      step: 7,
      ...
      description:
        "Face an oral interview panel to assess your suitability for the position.",
      timeframe: "1 day",
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600">
              Follow these steps to begin your career as a San Francisco Deputy
              Sheriff. The entire process typically takes 6-8 months to
              complete.
            </p>
          </div>
                ...
                <CardContent className="pt-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-grow">
                      <h2 className="text-2xl font-semibold text-[#0A3C1F] mb-2">
                        {step.title}
                      </h2>
          ...
          <div className="mt-12 bg-blue-50 border border-blue-200 rounded-lg p-6">
            ...
            <p className="text-blue-700 mb-4">
              Make sure you meet all the requirements before starting your
              application. Our recruitment team is here to support you
