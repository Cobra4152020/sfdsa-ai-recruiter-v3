    ...
    <div className="container mx-auto px-4 py-12 max-w-4xl">
      <Card className="shadow-md">
        ...
        <CardContent className="p-6 space-y-6 text-gray-700 dark:text-gray-300">
          ...
          <section>
            <h2 className="text-xl font-semibold text-primary mb-2">Cookies and Tracking Technologies</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-primary mb-2">Third-Party Services</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-primary mb-2">Your Data Protection Rights</h2>
            <p className="mb-2">
