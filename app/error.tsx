    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-white dark:bg-[#121212] p-4">
      ...
      <div className="text-center max-w-md">
        ...
        <div className="space-y-4">
          <Button
            onClick={reset}
            className="bg-primary text-white hover:bg-primary/90 dark:bg-[#FFD700] dark:text-primary dark:hover:bg-[#FFD700]/90"
          >
            Try again
          </Button>
          <Button
            ...
            className="ml-4 border-primary text-primary hover:bg-primary/10 dark:border-[#FFD700] dark:text-[#FFD700] dark:hover:bg-[#FFD700]/10"
          >
            Return home
          </Button>
        </div>
