  ...
  "sf-football": [
    {
      ...
      correctAnswer: "49ers",
      explanation:
        "The San Francisco 49ers are the NFL team based in San Francisco.",
      difficulty: "easy",
      category: "Sports",
    },
  ],
  "sf-baseball": [
    {
      ...
      explanation:
        "The San Francisco Giants play their home games at Oracle Park.",
      difficulty: "easy",
      category: "Sports",
    },
  ],
  "sf-basketball": [
    {
      ...
      explanation:
        "The Golden State Warriors moved from Oakland to the Chase Center in San Francisco.",
      difficulty: "easy",
      category: "Sports",
    },
  ],
  "sf-districts": [
    {
      ...
      gameId: "sf-districts",
      question:
        "Which San Francisco district is known for its Italian restaurants and cafes?",
      options: ["North Beach", "Mission", "Castro", "Haight"],
      correctAnswer: "North Beach",
      explanation:
        "North Beach is San Francisco's Little Italy, known for its Italian restaurants and cafes.",
      difficulty: "easy",
      category: "Geography",
    },
  ],
  "sf-tourist-spots": [
    {
      ...
      explanation:
        "Alcatraz Federal Penitentiary was a maximum security federal prison on Alcatraz Island.",
      difficulty: "easy",
      category: "History",
    },
  ],
  "sf-day-trips": [
    {
      ...
      explanation:
        "Both Napa Valley and Sonoma Valley are famous wine regions north of San Francisco.",
      difficulty: "easy",
      category: "Geography",
    },
  ],
