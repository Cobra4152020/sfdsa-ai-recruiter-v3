...
const STATIC_CHALLENGES = [
  {
    ...
    description:
      "Show your moves in uniform! Share your best dance moves while representing SFDA.",
  ...
  },
  {
    ...
    description:
      "Share a moment of positive community interaction while on duty.",
    startDate: "2024-01-01",
    endDate: "2024-12-31",
    points: 150,
    active: true,
    requirements: [
      "Must show positive interaction",
      "Get permission to share",
      "Use #SFDACommunity hashtag",
    ],
    completed: false,
  },
  {
    ...
    title: "Training Day",
    description:
      "Share a glimpse of your training routine or preparation for the academy.",
    startDate: "2024-01-01",
    endDate: "2024-12-31",
    points: 120,
    active: true,
