...
const gameId = "sf-football"
const gameName = "San Francisco Football Trivia"
const gameDescription = "Test your knowledge of San Francisco's football history and culture."
const badgeTypes = {
...
export default function SFFootballTriviaPage() {
