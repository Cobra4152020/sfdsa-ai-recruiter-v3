...
export default function SFBaseballTriviaPage() {
  const [activeTab, setActiveTab] = useState("play")
  const gameId = "sf-baseball"
  const gameName = "SF Baseball Trivia"
  const gameDescription = "How much do you know about the San Francisco Giants and baseball in the Bay Area?"
