...
import { Trophy, Award, Lock, Star, Zap, MessageSquare, FileText, Download, Clock, CheckCircle, Users, Gift, Share2 } from "lucide-react"
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-10">
            <h1 className="text-4xl font-bold text-[#0A3C1F] mb-4">Gamification</h1>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Earn points, unlock achievements, and compete with other recruits in our gamified recruitment process.
            </p>
          </div>
          ...
          <Tabs defaultValue="points" className="space-y-6">
            <TabsList className="grid grid-cols-6 mb-8">
              ...
              <TabsTrigger value="trivia" className="text-sm sm:text-base">
                <MessageSquare className="h-4 w-4 mr-2 hidden sm:inline" /> Trivia
              </TabsTrigger>
            </TabsList>
                      ...
                      <ul className="space-y-4">
                        <li className="flex items-start">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-600">5 points per meaningful interaction</p>
                          </div>
                        </li>
                        <li className="flex items-start">
                          <FileText className="h-5 w-5 text-[#0A3C1F] mr-2 mt-0.5" />
                          <div>
                            <p className="font-medium">Complete Practice Tests</p>
                            <p className="text-sm text-gray-600">20 points per test</p>
                          </div>
                        </li>
                        <li className="flex items-start">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-600">10 points per review</p>
                          </div>
                        </li>
                      </ul>
                    </div>
                    <div>
                      <h3 className="text-lg font-semibold mb-4">Point Tiers</h3>
                      <ul className="space-y-4">
                        <li className="flex items-start">
                        ...
                        <li className="flex items-start">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-600">2,500 points</p>
                          </div>
                        </li>
                        <li className="flex items-start">
              ...
              <Card>
                ...
                <CardContent className="p-6">
                  <p className="mb-6">
                    ...
                    Each badge represents a significant achievement in your path to becoming a San Francisco Deputy Sheriff.
                  </p>
            ...
            <TabsContent value="referrals">
              <Card>
                ...
                <CardContent className="p-6">
                  <p className="mb-6">
                    Earn bonus points and exclusive rewards by referring qualified candidates to the SF Sheriff's Department.
                  </p>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <ul className="space-y-4">
                        <li className="flex items-start">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-600">Get a unique link to share with potential recruits</p>
                          </div>
                        </li>
                        <li className="flex items-start">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-600">Monitor your referrals' progress</p>
                          </div>
                        </li>
                        <li className="flex items-start">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-600">Get points and exclusive badges for successful referrals</p>
                          </div>
                        </li>
                      </ul>
                    </div>
            ...
            <TabsContent value="unlockables">
              <Card>
                ...
                <CardContent className="p-6">
                  <p className="mb-6">
                    Unlock exclusive content and resources as you progress through the recruitment process.
                  </p>
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <TabsContent value="trivia">
              <Card>
                ...
                <CardContent className="p-6">
                  <p className="mb-6">
                    Test your knowledge about San Francisco and law enforcement through our daily trivia challenges.
                  </p>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
