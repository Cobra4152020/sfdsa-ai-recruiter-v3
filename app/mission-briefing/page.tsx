...
export const metadata: Metadata = {
  ...
  description: "Learn about the San Francisco Deputy Sheriff role, requirements, benefits, and application process.",
  keywords: "deputy sheriff, mission briefing, benefits, recruitment, law enforcement career, San Francisco",
}
