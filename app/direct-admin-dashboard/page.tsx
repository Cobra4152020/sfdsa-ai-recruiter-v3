  ...
  return (
    <div className="min-h-screen bg-gray-100 p-4">
      <div className="max-w-5xl mx-auto bg-white p-8 rounded-lg shadow-lg">
        <h1 className="text-3xl font-bold mb-6 text-green-800">Admin Dashboard (No Auth)</h1>

        <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 mb-6">
          <p className="text-yellow-700">
            ⚠️ This is a static version of the admin dashboard with no authentication or database dependencies.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-white p-6 rounded-lg shadow border-t-4 border-blue-500">
            ...
            <p className="text-gray-600 mb-4">Test and fix database connections</p>
            <a
