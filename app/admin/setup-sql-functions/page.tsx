    ...
    <div className="container mx-auto py-10">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Create utility SQL functions needed by the application.</CardDescription>
        </CardHeader>
        <CardContent>
          <p className="text-sm text-gray-500 mb-4">This will create the following SQL functions:</p>
          <ul className="list-disc pl-5 space-y-1 text-sm text-gray-500">
            <li>
              <code>check_table_exists</code> - Checks if a table exists in the database
            </li>
            <li>
              <code>exec_sql</code> - Executes arbitrary SQL (for admin use only)
            </li>
          </ul>
