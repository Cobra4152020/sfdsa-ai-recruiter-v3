...
export default function AdminTikTokChallengesPage() {
  ...
  useEffect(() => {
    filterChallenges();
  }, [challenges, searchQuery, filterChallenges]);
      ...
      const mockChallenges = [
        {
          ...
          description:
            "Create a TikTok showing what you think a day in the life of a SF Sheriff's Deputy looks like.",
        ...
        },
        {
          ...
          description:
            "Create a creative TikTok about patrolling a famous San Francisco landmark as a deputy.",
          ...
          <Card key={challenge.id} className="overflow-hidden">
            <div className="h-40 bg-gray-100 relative">
              ...
              <div className="absolute top-2 right-2">
                <Badge
                  className={getChallengeStatusBadgeStyle(challenge.status)}
                >
    ...
    if (pendingSubmissions.length === 0) {
      return (
        <div className="text-center py-12">
          ...
          <p className="text-gray-500 mt-1">
            That&apos;s all the challenges for now. Check back soon!
          </p>
        </div>
      );
    }
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h3 className="font-medium">
                          {submission.user?.displayName || "Anonymous User"}
                        </h3>
                    ...
                    <div className="flex gap-2 mt-4">
                      <Button
                        ...
                        className="flex-1"
                        onClick={() =>
                          handleReviewSubmission(submission.id, true)
                        }
                      >
                      ...
                      <Button
                        ...
                        className="flex-1"
                        onClick={() =>
                          handleReviewSubmission(submission.id, false)
                        }
                      >
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8">
        <div>
          ...
          <p className="text-gray-600 mt-1">
            Manage TikTok challenges and review submissions
          </p>
        </div>
