      ...
      <div className="grid gap-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>View and manage your daily briefings.</CardDescription>
          </CardHeader>
          <CardContent>
            {briefings && briefings.length > 0 ? (
              <div className="space-y-4">
                {briefings.map((briefing) => (
                  <div key={briefing.id} className="p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
                    <h3 className="font-semibold">{briefing.title}</h3>
                    <p className="text-sm text-gray-600 dark:text-gray-300 mt-1">{briefing.content}</p>
              ...
              <Alert>
                ...
                <AlertDescription>
                  There are no daily briefings set up yet. Use the initialization tool above to create the table.
                </AlertDescription>
              </Alert>
            )}
          </CardContent>
