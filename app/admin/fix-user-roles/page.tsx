  ...
  return (
    <div className="container mx-auto py-8">
      ...
      <div className="bg-white p-6 rounded-lg shadow-md">
        ...
        <p className="mb-4">This utility will add the missing columns to the user_roles table:</p>
        ...
        <div className="bg-amber-50 border border-amber-200 p-4 rounded-md mb-6">
          <p className="text-amber-800">
            <strong>Note:</strong> This will modify your database schema. Existing records will have their assigned_at
            set to created_at and is_active set to TRUE.
          </p>
        </div>
