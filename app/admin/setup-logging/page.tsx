    ...
    <main className="container mx-auto px-4 py-8">
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center mb-6">
          ...
          <h1 className="text-3xl font-bold text-[#0A3C1F]">Logging Configuration</h1>
        </div>

        <Card>
          <CardHeader>
            <CardTitle>Setup Application Logging</CardTitle>
            <CardDescription>Configure how the application handles logging and monitoring</CardDescription>
          </CardHeader>
          <CardContent>
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-sm text-gray-500">Turn application logging on or off</p>
                    </div>
                    <Switch
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      placeholder="json"
                    />
                    <p className="text-sm text-gray-500">Choose between json or text format</p>
                  </div>
                </div>
              </TabsContent>
                ...
                <div className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      placeholder="file"
                    />
                    <p className="text-sm text-gray-500">Where to store the logs (file, stdout, etc.)</p>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    />
                    <p className="text-sm text-gray-500">Path where log files will be stored</p>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setConfig({ ...config, retentionDays: parseInt(e.target.value) || 0 })
                        }
                        placeholder="30"
                      />
                      <p className="text-sm text-gray-500">How long to keep log files</p>
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        placeholder="100mb"
                      />
                      <p className="text-sm text-gray-500">Maximum size before rotation</p>
                    </div>
                  </div>
                </div>
              </TabsContent>
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-sm text-gray-500">Enable cloud storage for logs</p>
                    </div>
                    <Switch
                      checked={config.cloudEnabled}
                      onCheckedChange={(checked) => setConfig({ ...config, cloudEnabled: checked })}
                    />
                  </div>
                    ...
                    <>
                      ...
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          onChange={(e) => setConfig({ ...config, cloudBucket: e.target.value })}
